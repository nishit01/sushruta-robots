...
/*
Function to create robot(by getting its co-ordinates) and placing it in that particular
location.
*/
...
/*
Function to create station(by getting its co-ordinates) and placing it in that particular
location.
*/
